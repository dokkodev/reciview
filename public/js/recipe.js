...
var recipe_card_templete = function(recipe){
	return [
		'<div class="col col-3">',
			'<div class="card recipe-card text-center">',
				...
				'<div class="card-body">',
					'<img class="card-img" src="',recipe.img_url,'">',
					'<div class="row edit-enter-wrapper">',
						'<button type="button" class="btn edit-button col">Edit</button>',
...
recipe_list.map(function(v){
	$("#newadd-card").before(recipe_card_templete(v));
	});
});